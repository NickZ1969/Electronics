...
void setPinMapping(byte boardID)
{
  switch (boardID)
  {
    ...
    case 3:
      ...
      //pinInjector5 = 9; //Output pin injector 5 is on
      //pinInjector3 = 10; //Output pin injector 6 is on
      //pinInjector4 = 11; //Output pin injector 7 is on
      //pinInjector5 = 12; //Output pin injector 8 is on     
